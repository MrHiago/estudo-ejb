...
public class LivrariaWSServiceLocator extends org.apache.axis.client.Service implements br.com.caelum.livraria.service.LivrariaWSService {
    ...
    public br.com.caelum.livraria.service.LivrariaWS getLivrariaWSPort() throws javax.xml.rpc.ServiceException {
    ...
    public br.com.caelum.livraria.service.LivrariaWS getLivrariaWSPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.caelum.livraria.service.LivrariaWSServiceSoapBindingStub _stub = new br.com.caelum.livraria.service.LivrariaWSServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.caelum.livraria.service.LivrariaWS.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.caelum.livraria.service.LivrariaWSServiceSoapBindingStub _stub = new br.com.caelum.livraria.service.LivrariaWSServiceSoapBindingStub(new java.net.URL(LivrariaWSPort_address), this);
                _stub.setPortName(getLivrariaWSPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.livraria.caelum.com.br/", "LivrariaWSService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.livraria.caelum.com.br/", "LivrariaWSPort"));
        }
